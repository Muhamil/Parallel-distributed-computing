...
recvdata = numpy.zeros(array_size, dtype=int)  # Use int here instead of numpy.int
senddata = (rank + 1) * numpy.arange(array_size, dtype=int)  # Use int here instead of numpy.int
